        ...
        <div className='min-h-screen w-full tilt-in-top-1 font-sans'>
            ...
            <form action="" className='flex justify-center'>   
                <div className='grid  h-0  sm:mt-10 w-96 mx-5 sm:mx-0 sm:w-[600px] md:w-[700px] lg:w-[800px] gap-4 sm:gap-7'>
                   ...
                   <button type='submit' className='jello-horizontal h-[40px] grid place-items-center col-span-2 sm:text-base box-border bg-zinc-100 rounded-2xl standard-button'>{t('Submit')}</button>
